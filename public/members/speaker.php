...
<?php require_login(); ?>
<?php $pageTitle = 'Speaker'; ?>
<?php $pageSubtitle = 'Member Speaking Roles' ?>
...
<?php
  ...
  $speakingRoles = find_speaker_roles($memberID);
?>
<section id="main">
  <div class="container">
     <div class="row">
       ...
       <div class="col-md-9">
         ...
         <div class="panel panel-default">
           <div class="panel-heading main-color-bg">
             <h3 class="panel-title"><?php echo $memberName . " had a speaking role the following dates:"?></h3>
           </div>
           <div class="panel-body">
            ...
            <table class="table table-striped table-hover">
              ...
              <?php while ($agenda = mysqli_fetch_assoc($speakingRoles)) : ?>
              <tr>
              ...
              <?php mysqli_free_result($speakingRoles); ?>
